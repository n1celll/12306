...
# 候补截止兑换时间开车前：？小时 [2,3,4,... , 12960]
REALIZE_LIMIT_TIME = 2
...
OPEN_TIME = "2022-01-28 14:00:00"
# OPEN_TIME = "2022-01-27 15:09:00"
# 若为预售模式，则到设置的时间点才会进行登录操作，故建议设置提前开始时间，建议设置为 1800
# 且系统有可能提前放票，设置提前多少秒开始抢票（不提前：0，10分钟：600，半小时：1800）
ADVANCE_TIME = 1800
